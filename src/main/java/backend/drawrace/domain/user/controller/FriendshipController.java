...
public class FriendshipController {
    ...
    public RsData<List<FriendRequestResponse>> getReceivedRequests(
            @AuthenticationPrincipal SecurityUser securityUser) {
    ...
    public RsData<List<FriendRequestResponse>> getSentRequests(
            @AuthenticationPrincipal SecurityUser securityUser) {
    ...
    @GetMapping
    public RsData<List<FriendInfoResponse>> getFriendList(
            @AuthenticationPrincipal SecurityUser securityUser) {
